...
class Checkout extends Component {
    ...
    submitHandler = () => {
        ...
        axios.post("https://burger-f360a-default-rtdb.firebaseio.com/.json", order)
            .then(response => {
    ...
    render() {
        let form = (<div>
            ...
            <form style={{
                ...
                <br />
                <Button style={{ backgroundColor: "green" }} className="mr-auto" onClick={this.submitHandler} disabled={!this.props.purchasable}>Place Order</Button>
            ...
            <div>
                ...
                <Modal isOpen={this.state.isModalOpen}>
                    <ModalBody>
                        ...
                        <Link to='/'>
                            <Button color="secondary" className="ml-1">Go Back</Button>
                        </Link>
                    </ModalBody>
                </Modal>
            </div>
